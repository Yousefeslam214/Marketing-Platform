            ...
            <Pagination className="mt-6">
              <PaginationContent>
                <PaginationItem>
                  <PaginationPrevious
                    onClick={() =>
                      ads.pagination.hasPrevious && setPage((p) => (Number(p) - 1).toString())
                    }
                    className={
                      !ads.pagination.hasPrevious
                ...
                {/* Page numbers */}
                {Array.from({ length: ads.pagination.totalPages }, (_, i) => (
                  <PaginationItem key={i}>
                    <PaginationLink
                      isActive={ads.pagination.currentPage === i + 1}
                ...
                <PaginationItem>
                  <PaginationNext
                    onClick={() =>
                      ads.pagination.hasNext && setPage((p) => (Number(p) + 1).toString())
                    }
                    className={
                      !ads.pagination.hasNext
                        ? "pointer-events-none opacity-50"
                        : ""
                    }
                  />
