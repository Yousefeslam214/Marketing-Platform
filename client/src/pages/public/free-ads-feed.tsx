...
export default function FreeAdsFeed() {
  ...
  return (
    <div className={`min-h-screen bg-background ${isRTL ? "rtl" : "ltr"}`}>
      ...
      <div className={`
        ...
        ${isAuth ? "top-[64px] md:top-[97px]" : "top-[64px] md:top-0"}
      `}>
      ...
      <main className="p-2 md:p-6 flex flex-col items-center w-full">
        {isLoading ? (
          ...
          <div className="w-full flex flex-col items-center space-y-2 md:space-y-2">
            {/* Ads List */}
