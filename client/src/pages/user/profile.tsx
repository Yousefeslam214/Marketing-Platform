...
import { User, Mail, MapPin, Shield, Calendar, TrendingUp, CreditCard, Edit, Save, X, Eye, EyeOff } from 'lucide-react';
    ...
    return (
      <div className="container mx-auto p-6 max-w-4xl">
        <Alert variant="destructive">
          <AlertDescription>
            Failed to load profile data. {error?.message || 'Please try refreshing the page.'}
          </AlertDescription>
        </Alert>
      </div>
    );
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {isEditing && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="password">New Password <span className="text-sm text-gray-500">(Optional)</span></Label>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">
                    {t('profile', 'accountType')}:</span>
                <span>{profile.oauth === 'normal' ? t('profile', 'regularAccount') : t('profile', 'socialMediaAccount')}</span>
              </div>
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">
                    {t('profile', 'verificationStatus')}:</span>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between">
                <span className="text-gray-600">{t('profile', 'activeCampaigns')}:</span>
                <span className="font-semibold">{profile.adsCount}</span>
              </div>

              <div className="flex justify-between">
                <span className="text-gray-600">{t('profile', 'totalAmountSpent')}:</span>
                <span className="font-semibold">{formatCurrency(profile.totalSpend)}</span>
              </div>

              <Separator />

              <div className="flex justify-between">
                <span className="text-gray-600">{t('profile', 'availableBalance')}:</span>
                <div className="flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-green-600" />
                  <span className="font-semibold text-green-600">{formatCurrency(profile.balance)}</span>
                </div>
              </div>

              <div className="flex justify-between">
                <span className="text-gray-600">{t('profile', 'freeViewCredits')}:</span>
                <span className="font-semibold">{profile.freeViewsCredits.toLocaleString()}</span>
              </div>
            </CardContent>
          </Card>
        </div>
