...
export function TargetingForm({ onSubmit, defaultValues, isLoading }: TargetingFormProps) {
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            const updatedValue = checked
                              ? [...(field.value || []), gender]
                              : (field.value || []).filter((value) => value !== gender);
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            const updatedValue = checked
                              ...
                              : (field.value || []).filter((value) => value !== interest.value);
                            field.onChange(updatedValue);
                          }}
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            const updatedValue = checked
                              ...
                              : (field.value || []).filter((value) => value !== device.value);
                            field.onChange(updatedValue);
                          }}
                ...
                <FormItem>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {form.watch("budgetType") === "impressions" 
                      ? `Approximately ${Math.floor((field.value || 0) * 1000)} impressions per day`
